using Rebtel.UserManagement.Infrastructure.ExternalServices;
...
namespace Rebtel.UserManagement.WebApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IRebtelSubscriptionDomainService, RebtelSubscriptionDomainService>();
            container.RegisterType<IRebtelUserDomainService, RebtelUserDomainService>();
